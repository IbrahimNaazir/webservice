 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://login_ws/", wsdlLocation = "http://localhost:8080/employee_ws/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://login_ws/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/employee_ws/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://login_ws/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://login_ws/", "LoginPort"), Login.class, features);
    }
